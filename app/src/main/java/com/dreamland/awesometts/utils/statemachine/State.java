...
import com.dreamland.awesometts.BuildConfig;
...
public class State implements IState {
    ...
    public void enter() {
        if(DEBUG){
            Log.i("State","enter-->"+this.getName());
        }
    }
     ...
     *
     * @see com.dreamland.awesometts.utils.statemachine.IState#processMessage(Message)
     */
    @Override
